export const PROJECT_DATA = (<Omit<ProjectType, 'id'>[]>[
  {
  ...
  },
  {
    ...
    categories: [Category.FRONTEND, Category.BACKEND, Category.DEVOPS, Technology.GITHUB_ACTIONS],
    stack: [
      Technology.NUXT,
      Technology.NEST,
      Technology.NUXT_STRICT_FETCH,
  ...
  },
  {
    ...
    categories: [Category.FRONTEND],
    stack: [Technology.NUXT, Technology.TYPE_SCRIPT, Technology.MARKDOWN, Technology.SCSS, Technology.GITHUB_ACTIONS],
    tasks: [
  ...
  },
  {
    ...
    roles: [Role.FRONTEND],
    categories: [Category.FRONTEND],
    stack: [Technology.NEXT, Technology.REACT, Technology.TYPE_SCRIPT, Technology.SCSS, Technology.GITLAB_CI],
    tasks: [
  ...
  },
  {
    ...
    categories: [Category.FRONTEND, Category.BACKEND, Category.DEVOPS, Technology.GITLAB_CI],
    stack: [
      Technology.NEXT,
      Technology.REACT,
  ...
  },
  {
    ...
    roles: [Role.FRONTEND, Role.ARCHITECT],
    categories: [Category.FRONTEND],
    stack: [Technology.TYPE_SCRIPT, Technology.NUXT, Technology.OFETCH, Technology.GITHUB_ACTIONS],
    tasks: [
  ...
  },
  {
    ...
    categories: [Category.FRONTEND, Category.DEVOPS],
    stack: [Technology.REACT, Technology.MOBX, Technology.STYLE_MODULES, Technology.DOCKER, Technology.GITLAB_CI],
    tasks: [
  ...
  {
    title: 'Vitamins — интернет-магазин полезных продуктов',
...
]).map<ProjectType>(({ period: _1, ...item }, index) => Object.assign(item, { id: index + 1 }));
